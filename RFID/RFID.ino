...
String GOOGLE_SCRIPT_ID = "AKfycbz1rS0aelC9BERl97BMmqx8W6a6aMubv_VtlQa4M9wWIivwyCMLcejLxVs1oYrnR0Yz"; // Replace by your GAS service id
...
void setup() {
  ...
  lcd.begin(5, 4); //ESP8266-01 I2C with pin 5-SDA 4-SCL
